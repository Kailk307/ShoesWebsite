                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <div class="mb-3">
                                ...
                                <input name="name" value="<?= $row['name']; ?>" id="name" type="text" class="form-control" require placeholder="VD: giày ...">
                            </div>
                            <div class="mb-3">
                                <label for="metadesc">Mô tả(SE0)</label>
                                <textarea name="metadesc" id="metadesc" class="form-control" required required placeholder="VD:giày"><?= $row['metadesc']; ?></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="metakey">Từ khoá(SE0)</label>
                                <textarea name="metakey" id="metakey" class="form-control" required required placeholder="VD: giày nam siêu xịn"><?= $row['metakey']; ?></textarea>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="mb-3">
