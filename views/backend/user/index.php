<?php
use App\models\User;
//SELECT * from cqt_user WHERE status !=0 ORDER BY created _at DESC
            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="card-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <?php if($row['status']==1):?>
                                        <a class=" btn btn-sm btn-success " href=" index.php?
                        option=user&cat=status& id=<?=$row['id']?>">
                        ...
                        option=user&cat=detail& id=<?=$row['id']?>">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a class=" btn btn-sm btn-primary " href=" index.php?
                        option=user&cat=edit& id=<?=$row['id']?>">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a class=" btn btn-sm btn-danger " href=" index.php?
                        option=user&cat=delete& id=<?=$row['id']?>">
