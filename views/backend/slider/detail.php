...
//SELECT * from cqt_slider WHERE status !=0 ORDER BY created _at DESC
            ...
            <div class="card-body">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        option=slider&cat=status& id=<?=$row['id']?>">
                        ...
                        option=slider&cat=detail& id=<?=$row['id']?>">
                                    <i class="fas fa-eye"></i></a>
                                <a class=" btn btn-sm btn-primary " href=" index.php?
                        option=slider&cat=edit& id=<?=$row['id']?>">
                                    <i class="fas fa-edit"></i></a>
                                <a class=" btn btn-sm btn-info " href=" index.php?
                        option=slider&cat=deletel& id=<?=$row['id']?>">
