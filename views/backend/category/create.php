            ...
            <div class="card-body">
               <div class="row">
                   ...
                   <div class="mb-3">
                                ...
                                <input name="name" id="name" type="text" class="form-control" require placeholder="VD: Áo polo chính hãng">
                            </div>
                       <div class="mb-3">
                           <label for="metadesc">Mô tả(SE0)</label>
                           <textarea name="metadesc" id="metadesc" class="form-control" required required placeholder="VD: Áo polo chính hãng"></textarea>
                       </div>
                       <div class="mb-3">
                           <label for="metakey">Từ khoá(SE0)</label>
                           <textarea name="metakey" id="metakey" class="form-control" required required placeholder="VD: áo polo hàng nhập khẩu chất lượng cao"></textarea>
                       </div>
                   </div>
                   <div class="col-md-3">
                        <div class="mb-3">
