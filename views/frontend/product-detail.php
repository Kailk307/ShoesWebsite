    ...
    <section class="maincontent my-3">
        <div class="container">
            <div class="row product-header">
                <div class="col-md-6">
                    <img class="img-fluid border" src="public/images/product/<?= $row_product->image; ?>" class="rounded mx-auto d-block" width="500" alt="<?= $row_product->name; ?>">
                </div>
                <div class="col-md-6">
                    ...
                    3k3 Đã bán <i class="far fa-question-circle"></i>
                    <div>Vận chuyển: <i class="fas fa-shipping-fast"></i> vận chuyển nhanh</div>
                    <div>
                        <p>Các đơn vị vận chuyển: Chuyển phát nhanh,EWP,ship code</p>
                    </div>
                    <div>
                        <p>Số lượng: <?= $row_product->qty; ?></p>
                    </div>
